package com.rentup.app.web.rest.exceptions;

import com.rentup.app.application.user.UsernameAlreadyUsedException;
import java.net.URI;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public Mono<ResponseEntity<Problem>> handleEmailAlreadyUsedException(
        com.rentup.app.application.user.EmailAlreadyUsedException ex,
    ...
    public Mono<ResponseEntity<Problem>> handleInvalidPasswordException(
        com.rentup.app.application.user.InvalidPasswordException ex,
        ServerWebExchange request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.rentup.app");
    }
}
